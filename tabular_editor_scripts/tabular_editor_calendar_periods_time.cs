...
if (language == "en-US")
{
    ...
    // Create a mapping of text columns and their respective numeric columns for sorting
    var columnPairsPeriods = new Dictionary<string, string>
    {
    ...
    // Apply sorting for each text column
    foreach (var pair in columnPairsPeriods)
    {
    ...
    // Set the format for date-type columns
    var dateColumnsPeriods = new[] { "Date" };  // Columns that contain dates
    foreach (var columnName in dateColumnsPeriods)
    {
...
if (language == "pt-BR")
{
 // Create a mapping of text columns and their respective numeric columns for sorting
    ...
    // Set the format for date-type columns
    var dateColumnsPeriods = new[] { "Data" };  // Columns that contain dates
    foreach (var columnName in dateColumnsPeriods)
    {
        var column = periods_table.Columns[columnName];
        if (column != null)
...
if (language == "es-ES")
{
    ...
    // Set the format for date-type columns
    var dateColumnsPeriods = new[] { "Fecha" };  // Columns that contain dates
    foreach (var columnName in dateColumnsPeriods)
    {
        var column = periods_table.Columns[columnName];
        if (column != null)
...
// Disable aggregations for all columns in the time table
